...
class MayaCustomProviderSettings extends Table
    with TableInfo<MayaCustomProviderSettings, MayaCustomProviderSettingsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MayaCustomProviderSettings(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> settingsId = GeneratedColumn<int>(
    'settings_id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {settingsId};
  @override
  MayaCustomProviderSettingsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return MayaCustomProviderSettingsData(
      settingsId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}settings_id'],
      )!,
  ...
  @override
  MayaCustomProviderSettings createAlias(String alias) {
    return MayaCustomProviderSettings(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'CHECK (settings_id = 1)',
    'CHECK (length(endpoint_url) BETWEEN 1 AND 2048 AND endpoint_url = trim(endpoint_url))',
    'CHECK (updated_at_ms >= 0)',
  ];
}

class MayaCustomProviderSettingsData extends DataClass
    implements Insertable<MayaCustomProviderSettingsData> {
  final int settingsId;
  final String endpointUrl;
  final bool useApiKey;
  final int updatedAtMs;
  const MayaCustomProviderSettingsData({
    required this.settingsId,
  ...
  MayaCustomProviderSettingsCompanion toCompanion(bool nullToAbsent) {
    return MayaCustomProviderSettingsCompanion(
      settingsId: Value(settingsId),
  ...
  factory MayaCustomProviderSettingsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  MayaCustomProviderSettingsData copyWith({
    int? settingsId,
    String? endpointUrl,
    bool? useApiKey,
    int? updatedAtMs,
  }) => MayaCustomProviderSettingsData(
    settingsId: settingsId ?? this.settingsId,
    endpointUrl: endpointUrl ?? this.endpointUrl,
    useApiKey: useApiKey ?? this.useApiKey,
    updatedAtMs: updatedAtMs ?? this.updatedAtMs,
  );
  MayaCustomProviderSettingsData copyWithCompanion(
    MayaCustomProviderSettingsCompanion data,
  ) {
    return MayaCustomProviderSettingsData(
      settingsId: data.settingsId.present
          ? data.settingsId.value
  ...
  @override
  String toString() {
    return (StringBuffer('MayaCustomProviderSettingsData(')
          ..write('settingsId: $settingsId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is MayaCustomProviderSettingsData &&
          other.settingsId == this.settingsId &&
...
class MayaCustomProviderSettingsCompanion
    extends UpdateCompanion<MayaCustomProviderSettingsData> {
  final Value<int> settingsId;
  final Value<String> endpointUrl;
  final Value<bool> useApiKey;
  final Value<int> updatedAtMs;
  const MayaCustomProviderSettingsCompanion({
    this.settingsId = const Value.absent(),
    this.endpointUrl = const Value.absent(),
    this.useApiKey = const Value.absent(),
    this.updatedAtMs = const Value.absent(),
  });
  MayaCustomProviderSettingsCompanion.insert({
    this.settingsId = const Value.absent(),
    ...
    required int updatedAtMs,
       ...
       useApiKey = Value(useApiKey),
       updatedAtMs = Value(updatedAtMs);
  static Insertable<MayaCustomProviderSettingsData> custom({
    Expression<int>? settingsId,
  ...
  MayaCustomProviderSettingsCompanion copyWith({
    Value<int>? settingsId,
  ...
  @override
  String toString() {
    return (StringBuffer('MayaCustomProviderSettingsCompanion(')
          ..write('settingsId: $settingsId, ')
          ..write('endpointUrl: $endpointUrl, ')
          ..write('useApiKey: $useApiKey, ')
          ..write('updatedAtMs: $updatedAtMs')
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final MayaCustomProviderSettings mayaCustomProviderSettings =
      MayaCustomProviderSettings(this);
  @override
